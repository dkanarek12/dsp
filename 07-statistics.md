...
>> The probability Elvis was an identical twin given that he was a twin, P(H|D) = P(H)*P(D|H) / P(D),  
where P(H) is the probability of being an identical twin (1/300),  
P(D|H) is the probability of being a twin given you are an identical twin (1/1),  
and P(D) is the probability of being a twin (1/125 + 1/300).  
Therefore *P(H|D) = 29.41%.*  
